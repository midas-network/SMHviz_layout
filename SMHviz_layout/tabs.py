...
def make_tab_plots(sel_plot, tab_name_dict, show=None, plot_sel=None, css_plot_tabs="plot_tabs",
                   css_plot_tabs_container="plot_tabs-container",
                   css_right_sidebar="column right-sidebar", css_plot_tab="plot_tab",
                   css_plot_tab_sel="plot_tab--selected"):
    """Create the plot tabs on the SMH visualization websites

    Output a Div component with the plot tabs information with the Tabs component identified as
    `tab_plot`, and each individual tab with the internal id tab name informed in the `sel_plot`
    parameter.
    ...
    The output contains multiple CSS class information that need to be available:
        ...
        - `column right-sidebar`: style information for the right side of the page in the plot
            content (right of the sidebar)
        - `plot_tab`, `plot_tab--selected`: style information for an individual tab (and when
            selected)
    ...
    :parameter css_plot_tabs_container: string, name of the associated CSS element, see
        documentation
    ...
    :return: a Div component with the plot tabs information with the Tabs component identified as
        `tab_plot` with the
...
def make_round_tab(list_round, css_round_tab="round_tab", css_round_tab_sel="round_tab--selected"):
    """Make tab for each element of list_round
     ...
     The output contains multiple CSS class information that need to be available:
        - `round_tab`, `round_tab--selected`: style information for an individual tab (and when
            selected)
    An example CSS files containing all the information is available in the documentation of the
    package.
    ...
    round_tab_list = list()
    for i in list_round:
        tab = dcc.Tab(label=i, value=i, className=css_round_tab,
                      selected_className=css_round_tab_sel)
